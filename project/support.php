...
$_SESSION['support_tickets'] = $_SESSION['support_tickets'] ?? [];
$successMsg = '';
$errorMsg   = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($form === 'support_ticket') {
        ...
        if ($name === '' || $email === '' || $msg === '') {
            ...
            $ticketId = 'SUP'.str_pad(count($_SESSION['support_tickets'])+1, 3, '0', STR_PAD_LEFT);
    ...
    if ($form === 'ticket_status') {
        $tid = $_POST['ticket_id'] ?? '';
        $action = $_POST['action'] ?? 'close';
        foreach ($_SESSION['support_tickets'] as &$t) {
            if ($t['ticket_id'] === $tid && $t['user_id'] === $uid) {
                $t['status'] = ($action === 'reopen') ? 'open' : 'closed';
            }
        }
        unset($t);
    }
...
<section class="signup-section py-5">
  <div class="container">
    ...
    <!-- FAQs -->
    <div class="vendor-highlight mb-4 fade-up">
      <h3 class="section-title mb-3" style="font-size:1.3rem;">Frequently asked questions</h3>
      ...
      <div class="accordion" id="faqAccordion">
        <div class="accordion-item bg-transparent border-0">
          ...
          <div id="q1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
            <div class="accordion-body text-light small">
              Standard delivery usually takes <strong>2–4 working days</strong>. Express delivery
              (if selected at checkout) takes <strong>1–2 days</strong> in supported pin codes.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item bg-transparent border-0">
          ...
          <div id="q2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
            <div class="accordion-body text-light small">
              Once your return is picked up or approved, refunds are typically processed within
              <strong>5–7 working days</strong> to your original payment method.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item bg-transparent border-0">
          ...
          <div id="q3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
            <div class="accordion-body text-light small">
              You can see vendor information on the product page and vendor page. For critical
              issues, always raise a ticket here so ElectroHub can step in if required.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item bg-transparent border-0">
          <h2 class="accordion-header" id="q4h">
            <button class="accordion-button collapsed bg-transparent text-white" type="button"
              ...
              Is ElectroHub responsible for warranty?
            </button>
          </h2>
          <div id="q4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
            <div class="accordion-body text-light small">
              Warranty is generally honoured by the brand service centre. ElectroHub and the vendor
              help you with invoices and purchase proof.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item bg-transparent border-0">
          <h2 class="accordion-header" id="q5h">
            <button class="accordion-button collapsed bg-transparent text-white" type="button"
              ...
              What is the vendor payout timeline?
            </button>
          </h2>
          <div id="q5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
            <div class="accordion-body text-light small">
              In this demo project, data is not connected to real payments. In a real system,
              payouts usually happen within <strong>7–15 days</strong> after order delivery.
            </div>
          </div>
        </div>
      </div>
