...
$stmt = db()->prepare("
    SELECT o.*, oi.product_id, oi.product_name, oi.vendor_id, oi.vendor_name,
...
$main   = $lines[0];
$created= strtotime($main['created_at']);
$address= $main['address'] .' , '. $main['city'] .' - '. $main['pincode'];

$totalBase = array_sum(array_column($lines, 'line_total'));
      ...
      <div class="col-lg-7">
        <div class="vendor-highlight mb-3 fade-up">
          ...
          <?php foreach ($lines as $l):
            $product = get_product((int)$l['product_id']);
          ...
          ?>
            <div class="d-flex align-items-center mb-2">
              ...
              <div class="text-end">
                <div class="fw-bold">₹<?= number_format($l['line_total']) ?></div>
              </div>
            </div>
          <?php endforeach; ?>
        </div>
